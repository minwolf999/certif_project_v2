...
Devise.setup do |config|
  ...
  # config.secret_key = '4539e3231e747cd0eff86bc5e633aa9e7b5790e0368957f6b3f19462e2b217d07ce3629eb544d59bdfa07baf65f3ffade88efc66927c167fe5e86f3a376d80a0'
  ...
  if Rails.env.production?
    ...
    config.omniauth :github, ENV['GITHUB_CLIENT_ID_PROD'], ENV['GITHUB_CLIENT_SECRET_PROD']
  else
    ...
    config.omniauth :github, ENV['GITHUB_CLIENT_ID_DEV'], ENV['GITHUB_CLIENT_SECRET_DEV']
  end
  ...
  # config.pepper = '5dc03a5a7d91eb6549fc90d19cfbab0b8b5e65e7d4f949ee0326ab9b75813fe391c1346b29f947f034d2d144fbe02e7b187eba2544339bf22c0a00a847f79963'
